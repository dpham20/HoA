...
let AuthenticationService = class AuthenticationService {
    ...
    login(username, password) {
        ...
        //         return user;
        //     }));
        return this.http.post(`http://hoaa.api.ngrok.io/services/basic_auth/`, { username, password })
...
let AdminComponent = class AdminComponent {
     ...
     */
    constructor(HOAService, modalService, fb, userService, cd) {
...
const appRoutingModule = _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forRoot(routes);
...
class HOAService {
    ...
    getAllTickets() {
        ...
        return this.http.get(this.getAllTicketURL)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(data => new _app_Ticket__WEBPACK_IMPORTED_MODULE_2__["Ticket"](data)));
    }
    ;
    /**
     ...
     */
    getTicketById(id) {
        return this.http.get(this.getTicketByIdURL + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(data => new _app_Ticket__WEBPACK_IMPORTED_MODULE_2__["Ticket"](data)));
    }
    ;
    /**
...
let HomeComponent = class HomeComponent {
    constructor(userSerive, authenticationService) {
